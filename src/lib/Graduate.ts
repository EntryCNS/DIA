...
const termWeight: Partial<Record<SemesterKey, number>> = {
  grade11: 2, grade12: 2, grade21: 3, grade22: 3, grade31: 5, grade32: 5,
};

export function calcGradScore(input: Input) {
  // 학기별 A_ij, N_ij, 평균 계산
  const semesters: SemesterKey[] = ["grade11","grade12","grade21","grade22","grade31","grade32"];
